---
name: scoring-rubric
description: Công thức chấm điểm mức độ khớp giữa 1 job và profile ứng viên. Dùng bởi agent job-matcher và bất kỳ nơi nào cần đánh giá độ phù hợp job/CV. Định nghĩa trọng số, cách tính từng chiều, hard filter (dealbreakers), và cách xử lý dữ liệu thiếu.
---
...
### compensation (0–100)
- Cần đưa về cùng đơn vị (VND/tháng) — dùng skill `bilingual-normalization` để quy đổi USD↔VND & year↔month.
