---
name: job-schema
description: Schema chuẩn cho một tin tuyển dụng (job) và cách map dữ liệu thô từ search/scrape vào schema đó. Dùng bởi agent job-collector khi chuẩn hóa JD, và job-matcher khi đọc job.
---
